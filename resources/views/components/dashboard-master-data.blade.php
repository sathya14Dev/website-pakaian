...
<li>
    <button id="masterDataBtn"
        class="{{ $isActive ? 'bg-gray-200 text-gray-800' : 'bg-gray-100' }} 
        ...
        <span class="flex flex-row items-center gap-2">
            <svg fill="#000000" height="24px" width="24px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 503.56 503.56" xml:space="preserve">
        ...
        <i id="masterDataIcon"
            class="fa-solid {{ $isActive ? 'fa-angle-up' : 'fa-angle-down' }} 
