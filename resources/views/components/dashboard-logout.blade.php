<li>
    <a onclick="return confirm('Yakin ingin Keluar?')" href="/logout"
        class="{{ request()->is('logout') ? 'font-semibold' : 'text-gray-900' }} hover:bg-red-100 rounded-md w-full py-3 text-base flex flex-row gap-2 items-center pl-10">
