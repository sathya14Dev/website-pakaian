    ...
    <div class="px-6 py-8">
        ...
        <div class="mb-8">
            <h1 class="text-2xl font-semibold text-gray-500">
                Product/<span class="text-yellow-600">Edit</span>
            </h1>
        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <select class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 bg-white appearance-none cursor-pointer">
                                ...
                                <option value="Kebaya Modern" selected>Kebaya Modern</option>
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative group">
                                ...
                                <!-- Image Container -->
                                <div class="border border-gray-200 rounded-lg bg-gray-50 p-4 cursor-pointer hover:bg-gray-100 transition-all duration-200">
                                    <div class="flex flex-col items-center">
                                        <!-- Image with Overlay -->
                                        <div class="relative">
                                            <img src="https://images.unsplash.com/photo-1594633312681-425c7b97ccd1?w=100&h=100&fit=crop" 
                                        ...
                                        <p class="text-xs text-gray-500 mt-2">kebaya-anggun.jpg</p>
                        ...
                        <div class="md:col-span-2 space-y-2">
                            ...
                            <textarea 
                                rows="4"
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 resize-none">Kebaya modern elegan untuk acara formal</textarea>
                        </div>
